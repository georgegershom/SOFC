#!/usr/bin/env python3
"""
SOFC Thermal Data Generation and Analysis Runner
This script runs the complete SOFC thermal analysis pipeline
"""
...
def run_data_generator():
    ...
    try:
        import sofc_thermal_data_generator
        generator = sofc_thermal_data_generator.SOFCThermalDataGenerator()
...
def run_analysis():
    ...
    try:
        import sofc_thermal_analysis
        sofc_thermal_analysis.main()
...
def main():
    ...
    print("SOFC Thermal History Data Generation and Analysis")
    print("=" * 60)
    ...
    if not Path("sofc_thermal_data_generator.py").exists():
        print("✗ Error: sofc_thermal_data_generator.py not found in current directory")
        return
    ...
    print("  - sofc_sintering_interactive.html")
    print("  - sofc_steady_state_3d.html")
    print()
    print("📋 Report:")
